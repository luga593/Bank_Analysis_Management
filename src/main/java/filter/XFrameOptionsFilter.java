...
public class XFrameOptionsFilter implements Filter {
    ...
    public void doFilter(ServletRequest servletRequest, ServletResponse servletResponse,
        ...
        response.addHeader("X-Frame-Options", "ALLOW-FROM http://localhost:8080/Topicus/");
        //response.addHeader("X-Frame-Options", "ALLOW-FROM http://topicus-bank1.paas.hosted-by-previder.com/Topicus/");
